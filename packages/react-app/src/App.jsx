...
function App(props) {
  ...
  const deployedContractsObject = JSON.parse(JSON.stringify(deployedContracts));
  ...
  */
  ...
  let tokenSplitterAddress;
  const networkName = selectedNetwork.toString();

  if (deployedContracts[selectedChainId]) {
    console.log(selectedChainId);
    console.log(networkName)
    tokenSplitterAddress = deployedContracts[selectedChainId][networkName].contracts.TokenSplitter.address;
  }
      ...
      <Switch>
        <Route exact path="/">
          ...
          <Home
            ...
            address={address}
            pollingTime={localProviderPollingTime}
            localChainId={localChainId}
            userSigner={userSigner}
            mainnetProvider={mainnetProvider}
            tokenSplitterAddress={tokenSplitterAddress}
